...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"eXCg":[function(require,module,exports) {
var define;
...
},{"buffer":"dskh"}],"S3PC":[function(require,module,exports) {
"use strict";
  ...
  return (
    ...
    function (_superclass) {
      ...
      function _class() {
        ...
        _this = _possibleConstructorReturn(this, _getPrototypeOf(_class).call(this, opts));

        if (opts._prng) {
          // derive seed from a parent PRNG
          _this._SEED = opts._prng.random.getNextSeed();
        } else if (opts._SEED) {
          _this._SEED = opts._SEED;
        }

        _this.random = Random(_this._SEED);
        _this._SEED = _this.random.seed; // in event there was no seed
...
exports.default = _default;
},{"lodash":"B1iE"}],"sH94":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
},{"lodash":"B1iE","../index":"S3PC"}],"wVrK":[function(require,module,exports) {
"use strict";
